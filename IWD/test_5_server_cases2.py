...
Run for seveirty 3 excluding any case with severity 1, 3, 4 and 5
"""
...
print(f"----------> Starting Parallel Worker for cases with severity 2: {len(cases2_not_prev)}")

# 3. Processing Loop
for iii, sel_case in enumerate(cases2_not_prev):

...
problematic_uids_path = os.path.join(sat_test_folder, "problematic_uids_1_p2.csv")
...
cases1 = cases1[80:160]


print(f"----------> Starting Parallel Worker for cases with severity 1 part 2: {len(cases1)}")

...
problematic_uids_path = os.path.join(sat_test_folder, "problematic_uids_1_p4.csv")
...
print(f"----------> Starting Parallel Worker for cases with severity 1 part 4: {len(cases1)}")

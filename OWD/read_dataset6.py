...
root_path = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\6 Global distribution of the genera Gambierdiscus and Fukuyoa"
occurrence_file = 'occurrence.txt'
mof_file = 'measurementorfact.txt'

output_data = 'homogenized_dataset_6.csv'
output_summary = 'dataset_6_summary.csv'

def process_and_homogenize_d6():
    ...
    if 'eMoF_measurementUnit' in df_merged.columns and 'eMoF_measurementValue' in df_merged.columns:
        ...
        mask_abundance = df_merged['eMoF_measurementType'].astype(str).str.lower().str.contains('abundance|concentration|count|quantity|cell|density', na=False)
...
if __name__ == "__main__":
    try:
        process_and_homogenize_d6()
    except FileNotFoundError as e:
        print(f"Error: {e}. Please check if the txt files are correctly named and in the directory.")

...
if __name__ == "__main__":
    ...
    output_path = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\IWD CNN\res50\results1"
    Logger_path = output_path
    batch_size = 32
    num_workers = 8
    ...
    #model = HABLightningModel(mode='s2', lr=1e-4, weights_path=r'C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\IWD CNN\pretrained_model_weights\MoCo_ResNet50_S2-L1C 13 bands\B13_rn50_moco_0099_ckpt.pth')

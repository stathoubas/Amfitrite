# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 12:17:22 2026
...
def run_decoupled_prescreener(csv_path, output_dir, x_days, y_days, purity_days, gap_days, n_cases):
    ...
    # ID
    id_col = next((c for c in df.columns if c.lower() in ['id', 'id_x', 'hab_id', 'num']), None)
    if not id_col:
...
if __name__ == "__main__":
    ...
    # Update these paths to point to your new Excel/CSV files
    #INPUT_FILE = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\prd OAS\homogenized_habsos_after_Florida_v3.1_noFL.csv"
    INPUT_FILE = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\prd OAS\homogenized_habsos_after_Florida_v3.1_FL.csv"
    OUTPUT_DIR = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\prd OAS"
    
    run_decoupled_prescreener(INPUT_FILE, OUTPUT_DIR, x_days, y_days, purity_days, gap_days, n_cases)
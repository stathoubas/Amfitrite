...
problematic_uids_path = os.path.join(sat_test_folder, "problematic_uids_1_p3.csv")
...
cases1 = cases1[160:300]


print(f"----------> Starting Parallel Worker for cases with severity 1 part 3: {len(cases1)}")

...
def run_decoupled_prescreener(csv_path, output_dir, x_days, y_days, purity_days, gap_days, n_cases):
    ...
    # ID - ADDED 'sampleid' HERE FOR THIS SPECIFIC DATASET
...
if __name__ == "__main__":
    ...
    # Update these paths to point to your new dataset
    INPUT_FILE = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\California\homogenized_calhabmap.csv"
    OUTPUT_DIR = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\California"

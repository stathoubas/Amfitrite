# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 14:07:32 2026
...
def run_decoupled_prescreener(csv_path, output_dir, x_days, y_days, purity_days, gap_days, n_cases):
    ...
    # Support for Florida's 'karenia_brevis_abundance_cells_per_liter'
    qty_col = next((c for c in df.columns if 'karenia' in c.lower() or 'abundance' in c.lower() or 'organismq' in c.lower() or 'emof_measure' in c.lower() or 'individual' in c.lower()), None)

    # 2. Parse Dates (Support for Event_Date and eventDate)
...
if __name__ == "__main__":
    ...
    # Update these paths to point to your Florida Excel file
    FLORIDA_INPUT = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\Florida\Historic_Harmful_Algal_Bloom_Events_2015_-_2023_homogenised_v3_temp.csv"
    OUTPUT_DIR = r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\OWD\Florida"
    
    run_decoupled_prescreener(FLORIDA_INPUT, OUTPUT_DIR, x_days, y_days, purity_days, gap_days, n_cases)
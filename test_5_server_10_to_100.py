...
sat_test_folder = os.path.join(root_folder, "sat_data", "v4_3_10_to_100")
...
after2017_near_water = after2017[(after2017["distance_to_water_m"] > 10) & (after2017["distance_to_water_m"] <= 100)]

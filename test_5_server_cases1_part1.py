...
problematic_uids_path = os.path.join(sat_test_folder, "problematic_uids_1_p1.csv")
...
print(f"----------> Starting Parallel Worker for cases with severity 1 part 1: {len(cases1)}")

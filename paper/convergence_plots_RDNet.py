...
def generate_compact_convergence_plots(csv_path="metrics.csv", out_folder = ""):
    ...
    train_loss = epoch_data['train_loss_epoch']
    ...
    loss_filename = "plot_RDNet_loss_convergence_left.tiff"
    ...
    f1_filename = "plot_RDNet_f1_convergence_right.tiff"
...
if __name__ == "__main__":
    generate_compact_convergence_plots(r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\task2\IWD CNN\rdnet_base\results3\hab_experiment\version_0\metrics.csv", r"C:\Users\KostasPikounis\OneDrive_Inlecom_Personal\OneDrive - INLECOM\Amfitrite\paper\figures")
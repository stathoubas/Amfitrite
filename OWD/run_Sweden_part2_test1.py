# -*- coding: utf-8 -*-
"""
Created on Mon Mar  9 23:02:02 2026

@author: K. Pikounis

part1 (clustering and sat images selection) is perfromed by run_iainsdataset_part1_test1.py
"""
...
def run_heavy_pipeline(csv_path, output_root, model_paths):
    ...
    for index, row in df.iterrows():
        ...
        # Look for 'num' first (Iain's format), then generated_id from Phase 1 Imputation. Fallback to Row index.
        ...
        if not sat_item_id or sat_item_id.lower() == 'nan':
            # Suppress logs for empty rows unless it's a multiple of 100
            if index % 100 == 0:
